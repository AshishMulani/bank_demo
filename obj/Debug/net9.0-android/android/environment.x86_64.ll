...
@dso_cache = dso_local local_unnamed_addr global [52 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libcrypto.so
		ptr null; void* handle
	}, ; 3
	%struct.DSOCacheEntry {
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.bank_demo\00", align 16
...
@.DSOCacheEntry.11_name = private unnamed_addr constant [13 x i8] c"libcrypto.so\00", align 1
