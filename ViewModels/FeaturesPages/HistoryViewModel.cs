...
public class HistoryViewModel : INotifyPropertyChanged
{
    ...
    public HistoryViewModel()
    {
        ...
        {
            Transactions.Add(new TransactionModel { Description = "Paid to Rahul", Amount = 500, Date = DateTime.Today });
            Transactions.Add(new TransactionModel { Description = "Refund from Amazon", Amount = 1200, Date = DateTime.Today.AddDays(-1) });
            Transactions.Add(new TransactionModel { Description = "Grocery Shopping", Amount = 450, Date = DateTime.Today.AddDays(-2) });
            Transactions.Add(new TransactionModel { Description = "Electricity Bill", Amount = 900, Date = DateTime.Today.AddDays(-5) });
        }
